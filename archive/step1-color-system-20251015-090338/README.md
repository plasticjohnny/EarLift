...
**Conquer tone deafness with Irish-inspired ear training.**

An edgy, Irish traditional music-themed Progressive Web App for ear training. Master intervals, improve intonation, and recognize chords with Book of Kells-inspired design.
...
- 🎹 **Chord Recognition** - Master chord types and qualities
- 🎤 **Vocal Range Setup** - Personalized exercises based on your range
- 📱 **Installable PWA** - Works on mobile and desktop
- 🔌 **Offline Support** - Practice anywhere, anytime
- 🍀 **Irish-Themed Design** - Book of Kells-inspired aesthetic
...
- **Styling** - Pure CSS with Book of Kells-inspired theming
...
**ToneDeath** combines humor with serious functionality. The name playfully subverts "tone deaf" - you're conquering it, not embodying it. The Irish traditional music theme celebrates a culture with deep ear-training roots (sean-nós singing, session playing) while the Book of Kells aesthetic adds beauty and character.
