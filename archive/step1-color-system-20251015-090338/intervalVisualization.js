...
class IntervalVisualization {
    constructor(canvasId = 'intervalVizCanvasWebGL') {
        ...
        // Simplified settings - active features with shader-required disabled features at 0/false
        this.settings = {
            // Core visualization
            amplitude: 1.0,
            harmonicOrder: 5,
            ...
            // Gravity Wells (Pulsing Black Holes) - ACTIVE
            gravityWell: true,
            gravityStrength: 170.0,
            gravityWellCount: 5,
            gravityVariant5: true, // Pulsing Black Holes variant
            eventHorizon: 10.0,
            pulseDepth: 0.5,
            wellJitter: true,
            jitterIntensity: 1.0,
            ...
            // Shader-referenced disabled features (kept for compatibility)
    ...
    initializeSettingsUI() {
        // No settings UI needed - all features are now hardcoded in settings object
        // Gravity wells and other active features are controlled programmatically
    }

    // Removed initAdvancedBeatSettings() - all disabled features cleaned up
